...
export const fetchSchedules = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get("http://52.79.57.3:3003/schedules");
...
export const fetchScheduleById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await axios.get(`http://52.79.57.3:3003/schedules/${id}`);
      return response.data;
    } catch (error) {
...
export const addSchedule = createAsyncThunk(
  ...
  async (scheduleData, { rejectWithValue }) => {
    try {
      const response = await axios.post("http://52.79.57.3:3003/schedules", scheduleData);
      return response.data;
    } catch (error) {
...
export const updateSchedule = createAsyncThunk(
  ...
  async ({ id,scheduleData }, { rejectWithValue }) => {
    try {
      const response = await axios.put(`http://52.79.57.3:3003/schedules/${id}`, scheduleData);
      return response.data;
    } catch (error) {
...
export const  deleteSchedule= createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await axios.delete(`http://52.79.57.3:3003/schedules/${id}`);
      return response.data;
    } catch (error) {
