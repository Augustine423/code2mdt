...
const PilotRowView = ({ pilot }) => {
  ...
  return (
    <tr id="printArea" className="hover:bg-gray-100 border-b" ref={rowRef}>
      ...
      <td className="px-4 py-3 text-sm">{pilot.name}</td>
      <td className="px-4 py-3 text-sm">{pilot.employeeNo}</td>
      <td className="px-4 py-3 text-sm">{pilot.certificateNo}</td>
      <td className="px-4 py-3 text-sm">{pilot.flightNo}</td>
      <td className="px-4 py-3 text-sm">{pilot.flightTimeMinutes}</td>
