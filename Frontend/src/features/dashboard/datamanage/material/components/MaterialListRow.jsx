...
const MaterialListRow = ({
  material: { id, model, serialNo, manufacturer, useStatus, useTimeLifeTime },
}) => {
  return (
    <>
      <tr className=" border-b  hover:bg-gray-50">
        ...
        <td className="py-3 px-4 text-sm text-gray-700">{useTimeLifeTime}</td>
        <td className="py-3 px-4 text-sm text-gray-700">
          <Link
            to={`/dashboard/material-detail/${id}`}
