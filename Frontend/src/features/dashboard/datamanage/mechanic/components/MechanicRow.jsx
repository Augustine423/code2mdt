    ...
    <tr id="printArea" className="hover:bg-gray-100 border-b" ref={rowRef}>
      <td className="px-4 py-3">
        <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center overflow-hidden">
          <img
            src={mechanic.image}
            alt={mechanic.mechanic}
            className="w-[69px] h-auto object-contain"
          />
        </div>
      </td>
      <td className="px-4 py-3 text-sm">{mechanic.mechanic}</td>
      <td className="px-4 py-3 text-sm">{mechanic.employee_no}</td>
      <td className="px-4 py-3 text-sm">{mechanic.email}</td>
      <td className="px-4 py-3 text-sm">{mechanic.position}</td>
