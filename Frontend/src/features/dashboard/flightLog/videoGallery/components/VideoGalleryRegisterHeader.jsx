...
import VideoGalleryRegister from "../../videoGallery/components/VideoGalleryRegister";

const VideoGalleryRegisterHeader = () => {
  ...
  return (
    ...
    <header className="flex flex-col lg:flex-row items-center justify-between py-6 lg:gap-4 pl-10">
     ...
     <main className="p-6 ">
        {/* <DroneRegister/> */}
        <VideoGalleryRegister/>
      </main>
  </>
  )
}

export default VideoGalleryRegisterHeader