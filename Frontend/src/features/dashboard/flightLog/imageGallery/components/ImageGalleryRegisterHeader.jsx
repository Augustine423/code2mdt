...
import ImageGalleryRegister from "../../imageGallery/components/ImageGalleryRegister"

const ImageGalleryRegisterHeader = () => {
  ...
  return (
    ...
    <header className="flex flex-col lg:flex-row items-center justify-between py-6 lg:gap-4 pl-10">
     ...
     <main className="p-6 ">
        {/* <DroneRegister/> */}
        <ImageGalleryRegister/>
      </main>
  </>
  )
}

export default ImageGalleryRegisterHeader