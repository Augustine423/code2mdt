    ...
    <form onSubmit={handleSubmit(onSubmit)} className="h-full p-4 ">
      ...
      <div className="mb-8">
        ...
        <label className="block text-sm font-medium mb-1">Insert File</label>
          <span className="flex items-center gap-1"><FileUp className="size-5"/> My PC</span>
        </div>
        <label
          htmlFor="fileUpload"
      ...
      {/* Buttons */}
       {/* Buttons */}
       <div className="flex justify-end gap-4 flex-col mt-auto">
            <button
...
export default ImageGalleryRegister;
