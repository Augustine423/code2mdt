    ...
    <>
      ...
      <div className="mb-8 py-5">
        <div className="flex  justify-between  border-b pb-3">
          <h2 className="font-semibold text-lg text-gray-800">Drone Info.</h2>
      ...
      <div className="mb-8 py-5">
        <div className="flex items-center border-b pb-3">
          <h2 className="font-semibold text-lg text-gray-800">Issues</h2>
        </div>
        <div className="py-5 border-b">
          <div className="mx-10 ">
      ...
      <div className="mb-8 border-b pb-5">
        <div className="border-b pb-5 mb-4">
          <h2 className="font-semibold text-lg text-gray-800 ">Reference file</h2>
        </div>
        <div className="mx-10">
      ...
      <div className="mb-8 border-b pb-5">
        <div className="border-b pb-5 mb-4">
          <h2 className="font-semibold text-lg text-gray-800 ">Sign</h2>
        </div>
        <div className="mx-10">
          <div className=" flex  items-center mb-5">
            <label htmlFor="" className="min-w-[25%]">Team Leader</label>
            <div className="flex gap-3">
              <span className="bg-gray-200 px-2 rounded-full inline-flex items-center text-center text-gray-500">
                Necessity
              </span>
          ...
          <div className="  flex  items-center">
            <label htmlFor="" className="min-w-[25%]">Navigator</label>
            <div className="flex gap-3">
              <span className="bg-gray-200 px-2 rounded-full inline-flex items-center text-center text-gray-500">
                Necessity
              </span>
