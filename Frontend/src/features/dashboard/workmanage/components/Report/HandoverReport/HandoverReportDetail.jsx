...
const HandoverReportDetail = ({ report }) => {
  return (
    <>
      {/* Basic Info */}
      <div className="py-5">
          ...
          <div className="mx-10">
            ...
            <div className="flex">
              ...
              <div className="text-gray-800 flex">
                {report?.handover_date && (
                  <span>
                    <span className="mr-1">Start date</span>
                    {report.handover_date.startDate} ~{" "}
                    <span className="mr-1">End date</span>
                    {report.handover_date.endDate}
                  </span>
                )}
              </div>
            </div>
      ...
      <div className="mb-8 py-5">
        ...
        <div className="border-b pb-3">
          ...
          <div className="flex py-5 mx-5">
            ...
            <div className="text-gray-800">{report.reference}</div>
          </div>
        </div>
      </div>
          ...
          <div className="mx-10">
            ...
            <div className="flex w-full pt-5">
              <div className="flex w-1/2">
                ...
                <div className="text-gray-800">{report.requiredAction}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="gap-3 py-5 border-b ">
          <div className="mx-10">
            ...
            <div className="flex">
              ...
              <div className="text-gray-800">{report.taskRemarks}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-8 py-5">
        <div className="flex items-center justify-between border-b pb-3">
          <h2 className="font-semibold text-lg text-gray-800">Message</h2>
        </div>
