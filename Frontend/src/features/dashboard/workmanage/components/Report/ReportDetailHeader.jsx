...
import ReportSignPopup from "./ReportSignPopup";
import ReportPopupDetail from "./ReportPopupDetail";

const ReportDetailHeader = ({onPrint}) => {
    ...
    <div>
      ...
      <header className="flex flex-col lg:flex-row items-center justify-between py-6 lg:gap-4 pl-10">
        ...
        {report?.type !== "Incident Report" && (
          ...
          {reportPopup.isOpen && <ReportPopupDetail onClose={reportPopup.close} />}

          <button onClick={onPrint} className="py-2 px-3 flex justify-between">
